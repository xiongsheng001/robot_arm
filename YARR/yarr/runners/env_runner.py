...
class EnvRunner(object):
    ...
    def __init__(self,
        ...
        2. 回放缓冲区相关:
        - train_replay_buffer: 训练回放缓冲区
        - eval_replay_buffer: 评估回放缓冲区
        3. 运行迭代相关:
        - rollout_episodes: 每次rollout的episode数量
        - eval_episodes: 每次评估的episode数量
        - training_iterations: 总训练迭代数
        - eval_from_eps_number: 从哪个iter开始评估
        4. 其他超参数:
        - episode_length: 每个episode的长度
        - stat_accumulator: 统计累加器
        - rollout_generator: rollout生成器
        '''
