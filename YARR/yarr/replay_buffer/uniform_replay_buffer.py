...
import torch.distributed as dist #xiong
...
class UniformReplayBuffer(ReplayBuffer):
    ...
    def sample_transition_batch(self, batch_size=None, indices=None,
        ...
        # if 'task' in batch_arrays: #xiong
        # # if 'task' in batch_arrays and batch_arrays['task'] is not None:
        #     del batch_arrays['task']
        # if 'task_tp1' in batch_arrays: #xiong
        # # if 'task_tp1' in batch_arrays and batch_arrays['task_tp1'] is not None:
